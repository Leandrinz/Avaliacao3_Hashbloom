    ...
    for (;;) {
        ...
        case 4: {
            ...
            case 2: {
                ...
                if(!carregado_tabela) {
                    puts("É necessário inserir os valores originais para realizar um teste.");
                    puts("Insira os valores na opção 'Carregar Lote'.");
                    break;
                }
                if(exibir_dados_teste) {
                    puts("Verifique a seção de estatísticas para ver seu teste.");
                    break;
                }
                ...
                free(valores_teste);
                puts("Os resultados podem ser vistos na seção de estatísticas.");
                break;
            }
            default:
                break;
